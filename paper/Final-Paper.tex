...
\begin{table}[h]
  ...
  \begin{tabular}{lll}
    \toprule
    Challenge & Why It Is Hard & Proposed Solution \\
    \midrule
    Partial Observability & Agent only sees a 5x5 window & DRQN (LSTM memory) \\
    Non-Stationary Dynamics & Wind changes every 1000 episodes & QR-DQN (distributional RL) \\
    Costly Exploration & Agent stops exploring due to penalties & RND-DQN (exploration) \\
    \bottomrule
  \end{tabular}
\end{table}
